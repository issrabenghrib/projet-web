...
<html lang="en">
    <head>
        ...
        <title>Add  Travail - Dashboard</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Add Travail</h1>
                                  </div>
                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        ...
                                        <form id="addTravailForm" action="" method="POST">
                                            ...
                                            <input class="form-control form-control-user" type="text" id="typetravail" name="typetravail">
                                            <span id="typetravail_error" style="color: red;"></span><br>

                                            <label for="duree">Duree:</label><br>
                                            <input class="form-control form-control-user" type="text" id="duree" name="duree">
                                            <span id="duree_error" style="color: red;"></span><br>

                                            <label for="unite">Unite:</label><br>
                                            <select class="form-control form-control-user" id="unite" name="unite">
                                                <option value="Heure">Heure</option>
                                                <option value="Jour">Jour</option>
                                                <option value="Minute">Minute</option>
                                            </select><br>

                                            <button type="submit" class="btn btn-primary btn-user btn-block">Add Travail</button>
                                        </form>
                                        </div>
                                    </div>
                                </div>
